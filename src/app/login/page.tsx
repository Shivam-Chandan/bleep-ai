    ...
    >
      <div className="flex min-h-dvh items-center justify-center bg-background px-4">
        <div className="w-full max-w-sm space-y-6 animate-rise">
          ...
          <form key={mode} onSubmit={handleSubmit} className="space-y-4 animate-shift">
            ...
            {error && (
              <p className="text-sm text-red-500 animate-shift" role="alert">
                {error}
              </p>
            )}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-11 rounded-xl bg-primary text-primary-foreground font-medium hover:bg-primary/90 active:bg-primary/80 disabled:opacity-50 transition-colors flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
